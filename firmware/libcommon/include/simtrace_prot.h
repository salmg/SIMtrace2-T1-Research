...
/* payload is the INF field of a T=1 I-block rather than a T=0 TPDU fragment.
 * Card to host it carries one received block, with CEMU_DATA_F_FINAL set on
 * the last block of a chain; host to card it carries one chunk of the
 * response, again with CEMU_DATA_F_FINAL on the last one. */
#define CEMU_DATA_F_T1_BLOCK	0x00000010
